OUTPUT_PATH="./ckpts/MiniOpt-rl-phase2"
PRETRAIN_MODEL="../models/MiniOpt-rl-phase1"
TRAIN_DATA="../datasets/rl_dataset/phase2/train.parquet"
VAL_DATA="../datasets/rl_dataset/phase2/test.parquet"
...
python -m verl.trainer.main_ppo \
    ...
    trainer.total_epochs=5 $@ > ./log/training_phase2.log 2> ./log/training_phase2.error.log;
