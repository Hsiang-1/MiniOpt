# This is a rl script example for testing python environment using the example data
OUTPUT_PATH="./ckpts/EnvTest"
PRETRAIN_MODEL="../models/MiniOpt-Warmup"
TRAIN_DATA="../datasets/rl_dataset/example.parquet"
VAL_DATA="../datasets/rl_dataset/example.parquet"
...
python -m verl.trainer.main_ppo \
    ...
    trainer.total_epochs=1 $@ > ./log/env_test.log 2> ./log/env_test.error.log;  
